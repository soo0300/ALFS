      ...
      <div className="Container w-[800px] h-auto mt-[20px]">
        <div className="flex justify-around">
          <span
            ...
            className={
              (idx == 0 ? " text-green-600 font-extrabold mb-3 border border-green-600 rounded" : "text-gray-500") +
              " w-[150px] h-[30px] text-center pt-1"
            }
          >
            UP COMING
          </span>
          <span
            ...
            className={
              (idx == 1 ? " text-green-600 font-extrabold mb-3 border border-green-600 rounded" : "text-gray-500") +
              " w-[150px] h-[30px] text-center pt-1"
            }
          >
            NOW
          ...
          <span
            ...
            className={
              (idx == 2 ? " text-green-600 font-extrabold mb-3 border border-green-600 rounded" : "text-gray-500") +
              " w-[150px] h-[30px] text-center pt-1"
            }
          >
            SOLD OUT
