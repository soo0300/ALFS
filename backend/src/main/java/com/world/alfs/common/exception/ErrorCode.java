...
public enum ErrorCode {
    ...
    SPECIAL_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 특가 상품을 찾을 수 없습니다."),
    BOARD_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 문의입니다."),
    ...
    CANNOT_CHANGE_BOARD(HttpStatus.CONFLICT, "답변이 완료된 문의는 수정할 수 없습니다."),
